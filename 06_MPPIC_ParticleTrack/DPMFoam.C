...
int main(int argc, char *argv[])
{
    ...
    Info<< "Start_Particle_Tracking" << endl;
    // check for multiple time folders if they are not present produce producethem via the recomposepar
    // otherwiese run the particleTracking
